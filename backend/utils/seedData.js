...
const EMPLOYEES_SEED = [
  ...
  // 9 EMPLOYEES - ENGINEERING (Total 10 in Engineering with Manager)
  ...
  // 9 EMPLOYEES - PRODUCT (Total 10 in Product with Manager)
  ...
  // 9 EMPLOYEES - HR (Total 10 in HR with Manager)
  ...
  // 9 EMPLOYEES - FINANCE (Total 10 in Finance with Manager)
  ...
  // 9 EMPLOYEES - MARKETING (Total 10 in Marketing with Manager)
