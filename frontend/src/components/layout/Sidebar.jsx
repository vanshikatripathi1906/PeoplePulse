...
export const NAV_ITEMS = [
  ...
  { key: "profile", label: "My Profile", icon: User, roles: ["Employee"] },
  ...
  { key: "departments", label: "Departments", icon: Building2, roles: ["Admin", "Manager", "Employee"] },
  ...
  { key: "assets", label: "Assets", icon: Laptop, roles: ["Admin", "Manager", "Employee"] },
  { key: "rooms", label: "Meeting Rooms", icon: DoorOpen, roles: ["Admin", "Manager", "Employee"] },
  { key: "orgchart", label: "Org Chart", icon: Network, roles: ["Admin", "Manager"] },
  { key: "payroll", label: "Payroll", icon: Wallet, roles: ["Admin", "Employee"] },
